...
J'aurai aimé pouvoir renvoyer la position d'une erreur (numéro de la ligne + position dans cette ligne (numero du caractère) dans le fichier) comme c'est le cas dans n'importe quel IDE. Pour cela, j'aurais pu utiliser un objet LineNumberReader 
