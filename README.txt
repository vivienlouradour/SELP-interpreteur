...
J'aurai aimé pouvoir renvoyer la position d'une erreur (numéro de la ligne + position dans cette ligne (numero du caractère) dans le fichier). Pour cela, j'aurais pu utiliser un objet LineNumberReader 
